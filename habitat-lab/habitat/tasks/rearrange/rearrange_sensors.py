...
class RearrangeReward(UsesArticulatedAgentInterface, Measure):
    ...
    def __init__(self, *args, sim, config, task, **kwargs):
        ...
        self._count_coll_end_pen = self._config.count_coll_end_pen
    ...
    def reset_metric(self, *args, episode, task, observations, **kwargs):
        ...
        if self._want_count_coll():
            target_measure.extend(
                [RobotCollisions.cls_uuid, RobotCollisionsTerminate.cls_uuid]
            )
        self._prev_num_collisions = 0
    ...
    def _get_count_coll_reward(self):
        ...
        if (
            ...
            reward -= self._count_coll_end_pen
            self._task.should_end = True
